...
namespace Pavillion2015.DelaunayTriangulation
{
    ...
    {
        private List<DelaunayVertex> points;
        ...
        /// <returns></returns>
        public List<DelaunayVertex> ConvexHull(List<DelaunayVertex> points)
        {
        ...
        /// <returns></returns>
        public List<DelaunayVertex> ConvexHull(List<DelaunayVertex> points, bool rejectDuplicatePoints)
        {
            Hull hull = new Hull();
            ...
            List<DelaunayVertex> hullVertices = new List<DelaunayVertex>();
            foreach (HullVertex hv in hull)
                hullVertices.Add(new DelaunayVertex(hv.x, hv.y));
        ...
        public List<Triad> Triangulation(List<DelaunayVertex> points)
        {
        ...
        /// <param name="rejectDuplicatePoints">Whether to omit duplicated points</param>
        /// <returns></returns>
        public List<Triad> Triangulation(List<DelaunayVertex> points, bool rejectDuplicatePoints)
        {
            List<Triad> triads = new List<Triad>();
            Hull hull = new Hull();
