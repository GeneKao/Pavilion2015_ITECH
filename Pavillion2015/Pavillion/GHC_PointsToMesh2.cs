...
{
    public class GHC_PointsToMesh2 : GH_Component
    {
        ...
        double iBoundaryVertexThreshold = double.NaN;
        ...
        List<Plane> oDebugPlanes1 = null;
        List<Plane> oDebugPlanes2 = null;
        ...
        public GHC_PointsToMesh2()
            : base("Points to Mesh 2", "Points to Mesh 2",
                "Points to Mesh 2",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Boundary Vertex Threshold", "Boundary Vertex Threshold - 10", "Boundary Vertex Threshold", GH_ParamAccess.item, 0.05);
        ...
        protected override void BeforeSolveInstance()
        {
            ...
            oDebugPlanes1 = new List<Plane>();
            oDebugPlanes2 = new List<Plane>();
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach (Vertex vertex in oSpringMesh.Vertices)
            {
                if (vertex.IsBoundaryVertex || vertex.IsFixed) continue;
        ...
        {
            get { return new Guid("{85855199-ac9b-4a6c-af34-cb72a518bfaf}"); }
        }
    }
}